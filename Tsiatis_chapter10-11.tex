...
\begin{frame}{Today's agenda}
  ...
  \end{itemize}
  % Sources: overview of AIPWCC machinery and DR linear space J(!F^\perp) in Ch.10–11
...
\begin{frame}{Coarsened data \& notation: 10-second recap}
  ...
  \end{tcolorbox}
  % AIPWCC form and projection onto !2: (10.6)–(10.7); definition of DR linear space: Ch.10
...
\begin{frame}{Influence function geometry (for later)}
  ...
  \end{itemize}
  % DR linear space & operator J(·): Ch.10 Sec.10.1–10.2
